            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-group">
										...
										<li class="list-group-item"><strong>Emergency Phone Number :</strong> Emergency Phone Number</li>
										<li class="list-group-item"><strong>Invitor Friend Name :</strong> Invitor Friend Name</li>
										<li class="list-group-item"><strong>Advice For Group Development :</strong> Advice For Group Development</li>
                    </ul>
                </div>
            </div>
        </div>
